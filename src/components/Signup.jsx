...
export default function Signup() {
  return (
    <>
        <section className='sm:h-[50vh] md:h-[50vh] h-[30vh] grid place-items-center'>
            <div className="border-2 rounded-3xl h-72 grid place-items-center bg-yellow-400 lg:w-4/5 xl:w-4/5">
                <div className="grid place-items-center ">
                    ...
                    <div className='flex justify-center '>
                        <input type="text" name="signup" id="signupInput" placeholder='Enter your Email Address' className='border-2 rounded-2xl h-12 px-3 mt-5 '/>
                        <img src={Send} alt="Send" className='w-14 absolute right-0 mr-8 mr-[37%] mt-5' />
                    </div>
                </div>
            </div>
        </section>
